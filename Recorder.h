 ...
 * Possibly assign a group ID, such that not all events are started all the time.
 */
class Recorder {
	...
	public:
		...
		void addPAPI(int PapiEvent, int groupId = 0) __attribute__((no_instrument_function)) ;
